...
export class Form {
  constructor(validateParent, callbacks) {
    this._validator = new Validator();
    this._initPhoneInput = initPhoneInput;
    this._callbacks = callbacks;
    this._validState = false;
    this._validateParent = validateParent;
    this.init();
  }
  ...
  reset(form) {
    ...
    const parent = form.closest('[data-form-validate]') || form.closest('[data-partner-form="parent"]');
    form.reset();
  ...
  initFormElements(form, callback) {
  ...
  _initValidate(parent) {
    ...
    this.initFormElements(form, callback);
  }
